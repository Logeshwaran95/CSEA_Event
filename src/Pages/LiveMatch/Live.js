  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.currentPlayers}>
        <p className={styles.currentBattingTeam}>Batting: {matchStats.currentBattingTeam}</p>
        <p className={styles.currentBowlingTeam}>Bowling: {matchStats.currentBowlingTeam}</p>
